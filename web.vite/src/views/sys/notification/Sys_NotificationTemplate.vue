 ...
 *业务请在@/extension/sys/notification/Sys_NotificationTemplate.jsx或Sys_NotificationTemplate.vue文件编写
...
import extend from "@/extension/sys/notification/Sys_NotificationTemplate.jsx";
import viewOptions from "./Sys_NotificationTemplate/options.js";
...
editFormOptions.forEach((x) => {
  x.forEach((option) => {
    if (option.field == "NotificationContent") {
      option.height = 230;
    }
  });
});
