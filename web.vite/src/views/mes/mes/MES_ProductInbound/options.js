...
export default function(){
    ...
    const searchFormOptions = [[{"title":"单据号","field":"DocumentNo"},{"title":"物料名称","field":"MaterialName"},{"title":"物料编号","field":"MaterialCode"},{"dataKey":"货位","data":[],"title":"仓库","field":"WarehouseID","type":"select"},{"dataKey":"仓库","data":[],"title":"货位","field":"LocationID","type":"select"}]];
    const columns = [{field:'InboundID',title:'入库ID',type:'string',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       {field:'DocumentNo',title:'单据号',type:'string',link:true,width:120,align:'left'},
