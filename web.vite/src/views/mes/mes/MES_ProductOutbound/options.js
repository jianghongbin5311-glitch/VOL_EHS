...
export default function(){
    ...
    const editFormOptions = [[{"title":"单据号","field":"DocumentNo"},
                              ...
                              [{"title":"物料编号","required":true,"field":"MaterialCode"},
