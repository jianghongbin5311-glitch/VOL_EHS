...
const base = {
  ...
  let A = [
    ...
    { title: "余额" },
    { title: "地址", span: 3 },
    { title: "备注", span: 3, rate: !1 }
  ];
  return e && (A[A.length - 1].title = "同比增长", A[A.length - 1].rate = !0), A;
}, formData = (e) => {
  let l = {
    ...
    消费: ~~(Math.random() * 1e3),
    余额: ~~(Math.random() * 1e3),
    地址: "北京市海淀区中关村南大街33号10层1001室"
  };
  return e ? l.同比增长 = 65 : l.备注 = "这家伙很懒,没有留下任何可以看的说明信息...", l;
}, rankingData = () => [
  { name: "合格率", value: 95 },
  { name: "成品率", value: 80 },
  { name: "送检率", value: 70 },
  ...
  { date: "2024.01", 入库数量: 30, 出库数量: 0 },
  { date: "2024.02", 入库数量: 760, 出库数量: 560 },
  { date: "2024.03", 入库数量: 450, 出库数量: 789 },
  { date: "2024.04", 入库数量: 700, 出库数量: 280 },
  { date: "2024.05", 入库数量: 23, 出库数量: 800 },
  { date: "2024.06", 入库数量: 550, 出库数量: 470 },
  { date: "2024.07", 入库数量: 400, 出库数量: 210 },
  { date: "2024.08", 入库数量: 340, 出库数量: 545 },
  { date: "2024.09", 入库数量: 480, 出库数量: 100 },
  { date: "2024.10", 入库数量: 120, 出库数量: 310 },
  { date: "2024.11", 入库数量: 20, 出库数量: 230 },
  { date: "2024.12", 入库数量: 0, 出库数量: 50 }
], pieData = () => [
  { value: 1e3, name: "排产数量" },
  { value: 700, name: "计划数量" },
  { value: 450, name: "成品数量" },
    ...
    series: [
      {
        ...
        data: A
        //  [
        //     // { value: 1048, name: '排产数量' },
        //     // { value: 735, name: '计划数量' },
        //     // { value: 484, name: '成品数量' },
        //     // { value: 300, name: '报废数量' },
        //     // { value: 835, name: '入库数量' },
        //     // { value: 335, name: '出库数量' },
        //     // { value: 300, name: '未完成数量' },
        //     // { value: 580, name: '完成数量' }
        // ]
      }
    ]
  ...
  setup(e, { emit: A }) {
    ...
    const l = (g) => new URL((/* @__PURE__ */ Object.assign({ "./imgs/bar.png": __vite_glob_0_0$1, "./imgs/calendar.png": __vite_glob_0_1$1, "./imgs/card.png": __vite_glob_0_2$1, "./imgs/form.png": __vite_glob_0_3$1, "./imgs/gauge.png": __vite_glob_0_4$1, "./imgs/grid01.png": __vite_glob_0_5$1, "./imgs/grid02.png": __vite_glob_0_6$1, "./imgs/grid03.png": __vite_glob_0_7$1, "./imgs/grid04.png": __vite_glob_0_8$1, "./imgs/grid05.png": __vite_glob_0_9$1, "./imgs/line.png": __vite_glob_0_10$1, "./imgs/notice.png": __vite_glob_0_11$1, "./imgs/pie1.png": __vite_glob_0_12$1, "./imgs/rankinglist02.png": __vite_glob_0_13$1, "./imgs/rankinglist03.png": __vite_glob_0_14$1, "./imgs/step.png": __vite_glob_0_15$1, "./imgs/table.png": __vite_glob_0_16$1 }))[`./imgs/${g}`], import.meta.url).href, a = ref([
      ...
      },
      {
        ...
        isFont: !0,
        data: () => [
          { name: "全部数量", value: 7200 },
          { name: "待办数量", value: 2e3 },
          { name: "已办数量", value: 3e3 },
          { name: "延期数量", value: 1e3 },
          { name: "转办数量", value: 1200 }
        ]
      },
      {
        title: "栅格05",
      ...
      // { name: "选项卡", type: "tabs", img: "tabs.png" },
      {
        title: "通知列表",
        type: "notice",
        valueType: "array",
...
const VolTitle = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render], ["__scopeId", "data-v-eac0b45f"]]), _hoisted_1$a = { class: "vol-data-table" }, _hoisted_2$9 = { class: "vol-da-table" }, _hoisted_3$9 = {
  ...
  /* @__PURE__ */ createElementVNode("label", null, "默认条件")
], -1)), _hoisted_16$1 = { class: "custom-tabs-label" }, _hoisted_17$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createElementVNode("span", null, "属性设置", -1)), _hoisted_18$1 = {
  key: 0,
  class: "params-group"
  ...
  class: "params-group"
}, _hoisted_34 = { class: "fx" }, _hoisted_35 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createElementVNode("label", { class: "title" }, "小数位数", -1)), _hoisted_36 = { class: "custom-tabs-label" }, _hoisted_37 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createElementVNode("span", null, "事件处理", -1)), _sfc_main$3 = {
                          ...
                          createVNode(Q, {
                            ...
                            default: withCtx(() => [
                              createVNode(u, { value: "纵向显示" }, {
                                default: withCtx(() => [
                                  createTextVNode("纵向显示 ")
                                ]),
                                _: 1
                              }),
                              createVNode(u, { value: "横向显示" }, {
                                default: withCtx(() => [
                                  createTextVNode("水平显示 ")
                                ]),
                                _: 1
                              })
                            ]),
                ...
                e.currentItem.type != "pie" ? (openBlock(), createBlock(C, {
                  ...
                  default: withCtx(() => [
                    createVNode(s, {
                      "label-align": "left",
                      span: 1,
                      label: e.currentItem.type == "ranking" ? "进度条背景" : "标题颜色"
                    }, {
                      default: withCtx(() => [
              ...
              default: withCtx(() => [
                createElementVNode("div", _hoisted_6, [
                  createVNode(a, {
                    ...
                    default: withCtx(() => [
                      createTextVNode(toDisplayString(showAttr.value ? "收起" : "展开"), 1)
                    ]),
                    _: 1
                  }),
                  createVNode(a, {
